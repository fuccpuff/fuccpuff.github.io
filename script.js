...
document.addEventListener('DOMContentLoaded', () => {
    ...
    addTween("#economy_office", {transform: 'translateX(0)'}, '#economy_block', 400, 50)
    ...
    addTween("#sm2", bottomAnimation, '#objects_in_one_place', 350, -250)
    addTween("#sm3", bottomAnimation, '#objects_in_one_place', 350, -100)
    addTween(".windows_animation", bottomAnimation, '#objects_in_one_place', 450, -100)
    addTween("#object_info", translateX0, '#objects_in_one_place', 500, -100)
    addTween("#vector_img", bottomAnimation, '#objects_in_one_place', 700, -100)
    addTween("#bradley1", opacity1, '#objects_in_one_place', 550, -100)
    addTween("#cells_img_cadastral", opacity1, '#objects_in_one_place', 500, -100)
    addTween("#cells_img_important", opacity1, '#objects_in_one_place', 500, -100)

    /* экран "Анализ доходности" */
    // addTween("#sm4", bottomAnimation, '#profit_analysis', 200, -50)
    addTween("#sm5", bottomAnimation, '#profit_analysis', 700, -300)
    addTween("#sm6", bottomAnimation, '#profit_analysis', 800, -300)
    addTween("#count_object", translateX0, '#profit_analysis', 600, -250)
/*  adddTween("#bradley3", opacity1, '#profit_analysis', 200, -100)
    ...
    addTween("#sm9", bottomAnimation, '#contragents', 300, -100)
    addTween("#sm10", bottomAnimation, '#contragents', 400, -50)
    addTween("#cool_img", bottomAnimation, '#contragents', 200, -50)
/*  addTween("#bradley5", opacity1, '#contragents', 200, -100) */
    addTween("#bradley6", opacity1, '#contragents', 500, 100)
    addTween("#check_cells", opacity1, '#contragents', 700, -50)
/*  addTween("#ilya_cells", opacity1, '#contragents', 250, -150) */
    ...
    addTween("#sm12", bottomAnimation, '#references', 400, -150)
    addTween("#sm13", bottomAnimation, '#references', 400, -150)
    addTween("#clap_img", bottomAnimation, '#references', 300, -50)
    ...
    addTween("#sm15", bottomAnimation, '#actual_information', 400, -150)
    addTween("#sm16", bottomAnimation, '#actual_information', 400, -150)
...
/*  addTween(".doc_animation_3", docAnimation, '#actual_information', 200, 60)
    ...
    addTween("#sm18", bottomAnimation, '#checks', 600, -150)
    addTween("#sm19", bottomAnimation, '#checks', 600, -150)
    addTween("#headblow_img", bottomAnimation, '#checks', 300, 100)
    addTween("#sm20", scale1, '#checks', 150, 100)
    addTween("#sm21", scale1, '#checks', 175, 150)
    addTween("#sm22", scale1, '#checks', 200, 200)
    addTween("#lightning", scale1, '#checks', 300, 100)

    /* экран "Один сервис - одна команда" */
    addTween("#sm23", bottomAnimation, '#service_team', 300, -250)
    addTween("#sm24", bottomAnimation, '#service_team', 300, 90)
    addTween("#sm25", bottomAnimation, '#service_team', 300, 180)
    addTween("#sm26", bottomAnimation, '#service_team', 300, 270)
    addTween("#sm27", bottomAnimation, '#service_team', 300, 360)
    addTween("#sm28", bottomAnimation, '#service_team', 300, 450)
    addTween("#sm29", bottomAnimation, '#service_team', 300, 540)
// build scene
});